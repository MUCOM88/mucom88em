...
2019/10/22 v0.10(MUCOM88em 20191022) 公開日
           ・曲バイナリデータ領域を従来の約8.5KBから32KBに拡大
             (曲バイナリデータ領域をメインRAMから拡張RAMに移動)
           ・曲バイナリデータ領域とFM音色エディタ及びSSGプリセット音色データの領域競合を改善
2019/10/25 v0.20(MUCOM88em 20191025) 改修
           ・曲バイナリデータ領域とFMプリセット音色データの領域競合を改善
             (FMプリセット音色データをメインRAMから拡張RAMに移動)
           ・起動時の拡張メモリ搭載チェック機構を追加
           ・プリセット音色(@0、@1)が壊れる仕様バグの修正
2019/11/17 v0.30(MUCOM88em 20191117) 改修
           ・Jコマンドが正常に動作しないバグの修正
           ・メインメモリのフリーエリア拡大
             (FM音色エディタをメインRAMから拡張RAMに移動)
