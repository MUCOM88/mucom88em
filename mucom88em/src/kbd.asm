...
; ÉtÉ@ÉCÉãñº : kbd.asm (Z80ÉAÉZÉìÉuÉâÉ\Å[ÉX)
; ã@î\ : FMâπåπâπêFÉGÉfÉBÉ^
; çXêVì˙ÅF2019/11/17
;==========================================================================
; Å¶ñ{É\Å[ÉXÇÕMUSICLALF Ver.1.0Å`1.2ã§í ÇÃkbd.asmÇå≥Ç…çÏê¨ÇµÇΩï®Ç≈Ç∑ÅB
;==========================================================================
...
CURSOR:	EQU	0EF86H
CUR_ON:	EQU	04290H
;MSTART:EQU	0B000H					;Å°ïœçXëOÅFââëtÉãÅ[É`ÉìÇÃÉIÉtÉZÉbÉgïœçX
MSTART:	EQU	0C000H					;Å°ïœçXå„
MST:	EQU	MSTART+3*6
AKYOFF:	EQU	MST+3*2
PSGOUT:	EQU	MST+3*7
WKGET:	EQU	MST+3*8
...
; -- ägí£RAM ÉAÉNÉZÉXê›íËÉãÅ[É`Éì --	;Å°í«ãL
	
ERAM00:	EQU	095A0H			;Å°  ägí£RAM ÉâÉCÉgïsâ¬/ÉäÅ[Éhïsâ¬
ERAM01:	EQU	ERAM00+3		;Å°  ägí£RAM ÉâÉCÉgïsâ¬/ÉäÅ[Éhâ¬
ERAM10:	EQU	ERAM00+6		;Å°  ägí£RAM ÉâÉCÉgâ¬/ÉäÅ[Éhïsâ¬
ERAM11:	EQU	ERAM00+9		;Å°  ägí£RAM ÉâÉCÉgâ¬/ÉäÅ[Éhâ¬
ERAMB0:	EQU	ERAM00+12		;Å°  ägí£RAM ÉJÅ[Éh0/ÉoÉìÉN0
ERAMB1:	EQU	ERAM00+15		;Å°  ägí£RAM ÉJÅ[Éh0/ÉoÉìÉN1
...
;***********************************************************************	;Å°í«ãL
; MainRAMÇ…àÍéûìIÇ…bloadÇµÇΩâ∫ãLÉoÉCÉiÉäÇägí£RAMÇ…à⁄Ç∑èâä˙ê›íËÉãÅ[É`Éì		;Å°
; ÅEvoice.dat(FMÉvÉäÉZÉbÉgâπêFÉfÅ[É^)						;Å°
; ÅEkbd(FMâπêFÉGÉfÉBÉ^)								;Å°
; ãNìÆéûÇ…mlf88(basicÉçÅ[É_)Ç©ÇÁ"A=&HAD00:CALL A"Ç≈é¿çsÇ≥ÇÍÇÈ			;Å°
;***********************************************************************	;Å°

	ORG	0AD00H		;Å°
	
	CALL	ERAMB1		;Å°  ägí£RAM ÉJÅ[Éh0/ÉoÉìÉN1
	CALL	ERAM10		;Å°  ägí£RAM ÉâÉCÉgâ¬/ÉäÅ[Éhïsâ¬
	LD	DE,06000H	;Å°  FMÉvÉäÉZÉbÉgâπêFÉfÅ[É^ÇÃà⁄ìÆ ÉÅÉCÉìRAM C000HÅ®ägí£RAM ÉJÅ[Éh0/ÉoÉìÉN1 6000H
	LD	HL,0C000H	;Å°
	LD	BC,02000H	;Å°
	LDIR			;Å°
	LD	DE,04800H	;Å°  FMâπêFÉGÉfÉBÉ^ÇÃà⁄ìÆ ÉÅÉCÉìRAM 9A00HÅ®ägí£RAM ÉJÅ[Éh0/ÉoÉìÉN1 4800H
	LD	HL,09A00H	;Å°
	LD	BC,01300H	;Å°
	LDIR			;Å°
	CALL	ERAM00		;Å°  ägí£RAM ÉâÉCÉgïsâ¬/ÉäÅ[Éhïsâ¬
	CALL	ERAMB0		;Å°  ägí£RAM ÉJÅ[Éh0/ÉoÉìÉN0
	RET
